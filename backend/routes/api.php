...
Route::middleware(['builder.admin', 'throttle:api'])->prefix('builder')->group(function () {
    ...
    Route::put('/modules/{module}/fields/{field}/modify', [FieldController::class, 'modify']);
    Route::put('/modules/{module}/fields/{field}/rename', [FieldController::class, 'rename']);
    ...
    Route::post('/db/import/{table}', [DatabaseController::class, 'import'])->where('table', '[a-zA-Z0-9_]+');
    ...
    Route::delete('/db/{table}/rows/{id}', [DatabaseController::class, 'deleteRow'])->where('table', '[a-zA-Z0-9_]+');
    ...
    Route::put('/db/{table}/restore-name', [DatabaseController::class, 'restoreTableName'])->where('table', '[a-zA-Z0-9_]+');
